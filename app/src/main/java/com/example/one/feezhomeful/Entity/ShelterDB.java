...
public class ShelterDB {
    //Table Name
    public static final String TABLE_FEMALE="Shelter_Female";
    public static final String TABLE_MALE="Shelter_Male";
    public  static final String TABLE_SHELTER_FROM_DB="Shelter_From_DB";
    //tabel field
    public static final String KEY_ID="id";
    public static final String KEY_address1="address_1";
    public static final String KEY_address2="address_2";
